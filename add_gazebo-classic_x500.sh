...
cp -r $1/x500_modif/x500 "$1/PX4-Autopilot/Tools/simulation/gazebo-classic/sitl_gazebo-classic/models/"

# Add x500.world in Tools/simulation/gazebo-classic/sitl_gazebo-classic/worlds/
cp $1/x500_modif/x500.world "$1/PX4-Autopilot/Tools/simulation/gazebo-classic/sitl_gazebo-classic/worlds/"

# Add 1063_gazeo-classic_x500 in ROMFS/px4fmu_common/init.d-posix/airframes/
cp $1/x500_modif/1063_gazebo-classic_x500 "$1/PX4-Autopilot/ROMFS/px4fmu_common/init.d-posix/airframes/"

# Replace CMakeLists.txt in ROMFS/px4fmu_common/init.d-posix/airframes/
cp -f $1/x500_modif/CMakeLists.txt "$1/PX4-Autopilot/ROMFS/px4fmu_common/init.d-posix/airframes/"

# Replace sitl_targets_gazebo-classic.cmake in src/modules/simulation/simulator_mavlink/
cp -f $1/x500_modif/sitl_targets_gazebo-classic.cmake "$1/PX4-Autopilot/src/modules/simulation/simulator_mavlink/"
